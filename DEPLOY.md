# [ĐÃ CŨ — xem NODE_DEPLOY.md] Hướng dẫn đưa MiraiBot-Clean lên GitHub rồi deploy qua Render

> **Bot đã bỏ Docker và yt-dlp**, chuyển hẳn sang Node thuần (xem
> `NODE_DEPLOY.md`). Tài liệu bên dưới mô tả cách deploy kiểu Docker/Background
> Worker cũ, chỉ còn giá trị tham khảo lịch sử.
