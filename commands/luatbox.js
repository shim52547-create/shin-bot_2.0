...
module.exports = {
  config: {
    ...
    version: "1.0",
    role: 0,
    description: "Xem luật box (gõ trực tiếp \"Luật box\", không cần prefix)",
    usage: "luatbox (hoặc gõ thẳng \"Luật box\")",
  ...
  onChat: async ({ api, event }) => {
    ...
    if (body.indexOf("Luật box") === 0 || body.indexOf("luật box") === 0) {
      return api.sendMessage(RULES_TEXT, event.threadID, event.messageID);
    }
  }
};
